...
public final class ScheduledServiceManagerResource {
    ...
    public Throwable getFailureCause(
        ...
        final Optional<io.github.stack.guice.plugins.services.scheduledservice.AbstractScheduledService> optionalService = scheduledServiceManager.getService(service);
        if (optionalService.isPresent()) {
            final io.github.stack.guice.plugins.services.scheduledservice.AbstractScheduledService scheduledService = optionalService.get();
