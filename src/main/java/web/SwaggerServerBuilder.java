...
/**
 * TODO: workaround until I can get jetty and guice to play nicely with each
 * other
 */
public class SwaggerServerBuilder {

    private int port;
    private URI endpoint;
    private Injector injector;

    public SwaggerServerBuilder withPort(final int port) {
        this.port = port;
        return this;
    }

    public SwaggerServerBuilder withResourceEndpoint(final URI endpoint) {
        this.endpoint = endpoint;
        return this;
    }

    public SwaggerServerBuilder withInjector(final Injector injector) {
    ...
    private ContextHandler buildContext() {
        ...
        final Injector childInjector = injector.createChildInjector(new ServletModule() {
            ...
            protected void configureServlets() {
                ...
                parameters.put(PackagesResourceConfig.PROPERTY_PACKAGES, "example");
